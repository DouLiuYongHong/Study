            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_ERROR: {
                        ...
                        LogUtils.d(throwable.getMessage(), throwable);
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((com.ws.yonghong.doustudy.task.Callback.CancelledException) args[0]);
                        break;
                    }
